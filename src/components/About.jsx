  ...
  return (
    ...
    to-black text-white'>
      <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
        ...
        <p className='text-xl mt-20'>Hello, I'm Tegar Machfudzi, I'm a Java developer.Over 2,5 years of working experience in developing Java Backend. I am good at working with a team. I can understand work quickly and can adapt quickly
        </p>
