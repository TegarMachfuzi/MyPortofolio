...
export const hero: Localized<HeroContent> = {
  en: {
    ...
    intro:
      '3.5+ years designing APIs and data pipelines in Java, Spring Boot and Quarkus, with React and Next.js on the front end. I turn product direction into dependable, well-tested backend services.',
  ...
  id: {
    ...
    intro:
      'Lebih dari 3,5 tahun merancang API dan pipeline data dengan Java, Spring Boot, dan Quarkus, serta React dan Next.js di sisi front end. Saya mengubah arah produk menjadi layanan backend yang andal dan teruji.',
